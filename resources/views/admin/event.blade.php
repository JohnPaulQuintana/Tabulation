                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-2">
                        <div
                            ...
                            <div class="flex items-center gap-2">
                                <div>
                                    <a href="{{ route('admin.create') }}" class="bg-blue-500 p-2 rounded-sm text-white hover:bg-blue-700">+Event</a>
                                </div>
                                <div>
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li class="hover:bg-slate-100 p-4">
                                                <a href="#" class="flex items-center px-2">
                                                    <div class="h-2.5 w-2.5 rounded-full bg-green-500 me-2"></div> Online Event's
                                                </a>
                                            </li>
                                            <li class="hover:bg-slate-100 p-4">
                                                <a href="#" class="flex items-center px-2">
                                                    <div class="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> Offline Event's
                                                </a>
                                            </li>
                            ...
                            <tbody>
                                <tr
                                    ...
                                    <th scope="row"
                                        ...
                                        <img class="w-10 h-10 rounded-sm" src="{{ asset('images/experience-img.jpg') }}"
                                            alt="Jese image">
                                        <div class="ps-3">
                                            <div class="text-base font-semibold">AMA Campus model 2024</div>
                                ...
                                <tr
                                    ...
                                    <th scope="row"
                                        ...
                                        <img class="w-10 h-10 rounded-sm"
                                            src="{{ asset('images/experience-img.jpg') }}" alt="Jese image">
                                        <div class="ps-3">
                                            <div class="text-base font-semibold">AMA Campus model 2023</div>
                                            <div class="font-normal text-gray-500">San Jose Balanga Bataan</div>
                                        </div>
                                    </th>
                                    <td class="px-6 py-4">
