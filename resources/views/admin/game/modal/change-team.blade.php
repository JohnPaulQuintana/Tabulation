<div class="text-center hidden">
    <button id="changeModalGame" type="button"
        class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
        data-hs-overlay="#hs-change-game">
        Open modal
    </button>
</div>

<div id="hs-change-game"
    ...
    <div
        ...
        <div
            ...
            <form action="{{ route('admin.sports.change.selected') }}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="number" name="game_id" id="gameId" class="hidden">
                <input type="number" name="event_id" id="eventId" class="hidden">
