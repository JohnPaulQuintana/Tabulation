<div class="text-center hidden">
    <button id="openModalTeams" type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-teams">
      Open modal
    </button>
  </div>
  
  <div id="hs-teams" class="hs-overlay hs-overlay-backdrop-open:bg-slate-950/50 hidden size-full fixed top-10 start-10 z-[100000000] overflow-x-hidden overflow-y-auto">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all md:max-w-2xl md:w-full m-3 md:mx-auto">
      <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
        <div class="absolute top-2 end-2">
          <button type="button" class="closeModalTeams flex justify-center items-center size-7 text-sm font-semibold rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-transparent dark:hover:bg-neutral-700" data-hs-overlay="#hs-teams">
        ...
        <form action="{{ route('admin.sports.store.team') }}" method="post" enctype="multipart/form-data">
            @csrf
            <input type="number" name="event_id" id="sport_event_id" class="hidden">
            <div class="p-4 sm:p-10 overflow-y-auto">
            <div class="mb-6 text-center">
                <h3 class="mb-2 text-xl font-bold text-gray-800 dark:text-neutral-200">
                Team Profile and Name
                </h3>
                <p class="text-gray-500 dark:text-neutral-500">
                Add a new teams profile and names.
                </p>
            </div>
    
            <div class="space-y-4">
                <label class="block">
                    <span class="">Choose team profile</span>
                    <input type="file" name="team_profile" class="block w-full text-sm text-gray-500 bg-slate-100
                ...
                <div class="relative">
                    ...
                    @error('team_name')
                    <span class="text-red-500">Team Name is required.</span>
                    @enderror
                </div>
            </div>
            </div>
            ...
            <div class="max-w-[85rem] px-4 p-2 -mt-5 sm:px-6 lg:px-8 mx-auto">
              <h1>Created Teams : click the teams to enable editing</h1>
              <!-- Grid -->
                  ...
                  <div class="p-2 md:p-2">
                    <div class="flex justify-between items-center">
                      <div class="flex items-center">
                        <img class="size-[38px] rounded-full" src="https://images.unsplash.com/photo-1486299267070-83823f5448dd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80" alt="Image Description">
                        <div class="ms-3">
                          <h4 class="group-hover:text-blue-600 font-semibold text-gray-800 dark:group-hover:text-neutral-400 dark:text-neutral-200">
                            Sample Teams
                          </h4>
                        </div>
                      </div>
